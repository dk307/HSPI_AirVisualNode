...
namespace SharpCifs.Ntlmssp
{
    ...
    internal class Type1Message : NtlmMessage
    {
        ...
        public override byte[] ToByteArray()
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(suppliedWorkstation))
                {
                    ...
                    workstation = Runtime.GetBytesForString(suppliedWorkstation.ToUpper(System.Globalization.CultureInfo.InvariantCulture),
                                                            GetOemEncoding());
                }
                else
                {
